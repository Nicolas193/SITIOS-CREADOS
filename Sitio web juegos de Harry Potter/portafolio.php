...
<div class="container">
	...
	Nombre de la Noticia: <input required class="form-control" type="text" name="nombre" id="">
	<br/>
	descipcion: <input required class="form-control" type="text" name="descripcion" id="">
	<br/>
	Imagen de la Noticia: <input required class="form-control" type="file" name="imagen" id="">
	<br/>
