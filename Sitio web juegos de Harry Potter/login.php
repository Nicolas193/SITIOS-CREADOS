...
if($_POST){
	if(($_POST['user']=="Nicolas") && ($_POST['pass']=="Xdrscesg") ){

			$_SESSION['user']="Nicolas"; #cuando ingresar al link nuevamente se borra la contra y si o si tenes que inicar seccion de nuevo 

			header("location:portafolio.php"); #redirecciona al index
...
<div class="imageninicio"><img src="primeraimagen.gif" alt="" class="imageninicio_imag"></div>
	<h1> Solo Personal Administrativo</h1>

	<div class="container">

		<div class="row">

				<div class="dinastias"><img src="dinastia.png" alt="" class="dinastia_d"></div>
			<div class="col-md-4">
