...
while ($row = $resultado->fetch_assoc()) {
    // Limpiamos posibles fechas en historial_estados (si no querés las fechas)
    // Aquí no hay fecha en consulta para estados, solo nombre. Si la querés quitar, ajustá el SQL arriba.

    // En caso de querer limpiar, podés usar preg_replace aquí.
