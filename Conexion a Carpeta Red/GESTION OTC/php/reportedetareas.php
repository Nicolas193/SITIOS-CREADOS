...
$sql2 = "SELECT 
COUNT(DISTINCT id_persona_asignada) as Cantidad FROM registrodetareas";

$sql3 = "
SELECT dirigido_a, COUNT(*) as frecuencia
FROM (
    SELECT  dirigido_a , id_persona_asignada, MIN(fecha_solicitud) as fecha_min
...
<body>
  ...
  Total de Tareas: <?php echo $cantidad; ?>
